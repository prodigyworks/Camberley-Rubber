<?php
	...
	class PATReport extends CheckListReport {
			...
			try {
				...
				if ($result) {
					while (($this->headermember = mysql_fetch_assoc($result))) {
						...
						$this->dynamicY = $this->checkNotes2("Year 1", "year1", 44, $this->headermember, 40);
						$this->dynamicY = $this->checkNotes2("Year 3", "year3", $this->dynamicY, $this->headermember, 40);
						$this->dynamicY = $this->checkNotes2("Year 5", "year5", $this->dynamicY, $this->headermember, 40);
