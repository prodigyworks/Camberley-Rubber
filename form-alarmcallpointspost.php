<?php 
	...
	$cpid = $_POST['cpid'];
	$faultsfound = (isset($_POST['faultsfound']) && $_POST['faultsfound'] == "on") ? 1 : 0; 
	...
	$qry = "INSERT INTO {$_SESSION['DB_PREFIX']}alarmschecklist 
			(
				checklistid, signatureid, inspectiondate, cpid,
