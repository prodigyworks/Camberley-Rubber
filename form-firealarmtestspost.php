<?php 
	...
	$faultsfound = (isset($_POST['faultsfound']) && $_POST['doorlock'] == "on") ? 1 : 0; 
	$faultsfound_notes = mysql_escape_string($_POST['faultsfound_notes']); 
	$status = "Y";
	...
	$qry = "INSERT INTO {$_SESSION['DB_PREFIX']}alarmtestchecklist 
			(
				checklistid, signatureid, inspectiondate, 
				inspectionuserid, faultsfound, faultsfound_notes,
				correction_notes,
